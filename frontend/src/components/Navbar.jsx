...
function Navbar() {
    ...
    return (
        <nav className="bg-white shadow-md px-6 py-6 flex justify-between items-center fixed w-full top-0 z-50">
            <Link to="/" className="text-2xl font-bold text-gray-800">🛍️ GitaramoCart</Link>
            <Link to="/cart" className="text-lg font-semibold text-gray-800 relative hover:text-blue-600 font-medium">
                🛒 Cart
                {cartCount > 0 && (
